...
function user() {
   ...
   const actionBodyTemplate =()=>{
    return(
        <div className='flex gap-2'>
             <Link href={"/admin/masters/users/createUserpopup"}>
              <img
        src="/assets/svg/Edit_Square.svg"
         /></Link>
          <img
         src="/assets/svg/key_icon.svg"
          />
         <img
  ...
  return (
   ...
   <Layout pageTitle="Dashboard">
                ...
                <div className="">
                    <div className="dashboard-main-wrapper pr-4 mt-3">
                        <div className='wrapper-custom-views mt-8'>
                            ...
                            <div className="flex flex-1 flex-wrap xl:pt-5 md:pt-[5.25rem] px-0 top-action-wrapper">
                                <div className="md:flex xs:w-full sm:w-full md:w-auto flex-row align-center">
                                    ...
                                    <div className="md:flex block mb-4">
                                      <h2 className="page-title">Users
                                        <Tag severity="" value={`${users.length} Roles`} style={{ background: '#EFF8FF', color: '#0487C8', fontSize: 11, fontWeight: 500, padding: '0px 15px', height: 10 }} rounded></Tag>
                                      </h2>
                                    </div>
                                </div>
                                ...
                                <div className="md:flex flex-1 px-5 flex-row xs:w-full sm:w-full md:w-auto align-center justify-end md:ml-auto gap-3 right-side">
                                    <div className="md:flex block gap-3 items-center">
                                        ...
                                        <Link href="/admin/masters/users/createUserpopup"  className=" py-2 px-6 bg-btn-blue text-[#fff] transition ease-in duration-200 text-[14px] text-center font-medium  shadow-md focus:outline-none leading-6 bg-[#113699]  justify-center rounded-lg border border-[#D0D5DD] rounded-md">Create</Link>
                                        <Link href="abc"
                                            onClick={() => {
              ...
              <div className="mt-1">
                <Select options={defaultSearchFields} maxMenuHeight={200} placeholder="Search On" onChange={(e) => {
                  setSelectedSearchBy(e.value); setSelectedSearchLabel(e);
                }} value={selectedSearchLabel ? selectedSearchLabel : { label: "Search On", value: "" }} />
              </div>
              ...
              <div >
                <input
                  ...
                  className="text-[15px] rounded-lg  flex-1  border border-[#D0D5DD] w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-500 shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 mt-1 placeholder:text-[#667085] dark:bg-[#333231] dark:border-[#333231]"
                  placeholder="Search"
                />
              </div>
              ...
              <div style={{ display: 'none' }} >
                <DatePicker
                  placeholderText="Registered Date"
                  isClearable
                  className="w-full  border border-[#D0D5DD] w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-500 shadow-sm text-[16px] focus:outline-none focus:ring-1 focus:ring-blue-500 mt-2 placeholder:text-[#667085] rounded-md text-sm dark:bg-[#333231] dark:border-[#333231]"
                />
              </div>
              <div className="mt-1" style={{ display: 'none' }} >
                <Select maxMenuHeight={200} placeholder="Role" options={roleList}
                  onChange={(e) => {
              ...
              <div className="mt-1">
                <Select options={statusList} width='200px' maxMenuHeight={300} placeholder="Status" onChange={(e) => {
                  setSelectedStatus(e.value); setStatusLabel(e);
                }} value={statusLabel ? statusLabel : { label: "Status", value: "" }} />
              </div>
            </div>
                            <div>
                                <div className={"block w-full pt-5"}>
                                        ...
                                        {
                                        // <DataTable value={products} className='employeetable ' paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]}  customStyles={DataTableCustomStyles} showGridlines tableStyle={{ minWidth:"50rem"}}>
                                        // <Column field="code" header="Role"></Column>
                                        // <Column field="name" header="First Name"></Column>
                                        // <Column field="category" header="Last Name"></Column>
                                        // <Column field="description" header="Email"></Column>
                                        // <Column field="quantity" header="Status"></Column>
                                        // <Column field="rating" header="Created"></Column>
                                        // <Column body={actionBodyTemplate} header="Action" style={{ width: '8%' }}></Column>
