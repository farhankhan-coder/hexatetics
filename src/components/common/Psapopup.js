                    ...
                    <ul className="sideTabs">
                      ...
                      <li>
                        <a
                          ...
                          className={`${
                            props.attchmentAndDetailes === true
                              ? "tab-b active activeCheck"
                              : null
                          }`}
                          class="tab-b"
                            ...
                            <div className=" grid grid-cols-2 gap-8">
                              <div className="">
                                <div className="col ">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setPSAConsultanName1(e.target.value)
                                    }
                                    value={psaConsultanName1}
                                    type="text"
                                    name=""
                                    class="text-[16px] xl:text-[0.833vw] px-[14px] py-[10px] bg-white border border-[#D0D5DD] shadow-[0px_1px_2px_rgba(16,24,40,0.05)] placeholder-[#101828] focus:outline-none focus:border-[#D0D5DD] focus:ring-[#D0D5DD] block w-full rounded-[8px] xl:rounded-[0.417vw]"
                                    placeholder="Type here"
                                ...
                                <div className="col mt-1.5">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setPSAConsultantEmail1(e.target.value)
                                    }
                                    value={psaConsultantEmail1}
                                    type="text"
                                    name=""
                                    class="text-[16px] xl:text-[0.833vw] px-[14px] py-[10px] bg-white border border-[#D0D5DD] shadow-[0px_1px_2px_rgba(16,24,40,0.05)] placeholder-[#101828] focus:outline-none focus:border-[#D0D5DD] focus:ring-[#D0D5DD] block w-full rounded-[8px] xl:rounded-[0.417vw]"
                                ...
                                <div className="col">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setEmployerIdentification(e.target.value)
                                    }
                              ...
                              <div className="">
                                ...
                                <div className="col">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setPOCContactNumber(e.target.value)
                                    }
                          ...
                          <div className="mt-4">
                            ...
                            <div className="flex gap-4">
                              <div className="flex">
                                <input
                                  onChange={(e) => {
                                    setTypeOfBusinessEntity(e.target.value);
                          ...
                          <div className="flex items-center gap-4">
                            <div className="flex">
                              <input
                                ...
                                id="html"
                                onChange={(e) =>
                                  setScopeofwork(e.target.checked)
                                }
                          ...
                          <div className="flex items-center gap-2 mt-6">
                            <div className="flex">
                              ...
                              <label
                                ...
                                for="username"
                              >
                                Addendum Containing Specific Terms and
                                Conditions
                              </label>
                            </div>
