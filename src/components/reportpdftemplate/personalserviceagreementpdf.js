...
const PsaPdf = forwardRef((props, ref) => {
  const generatePDF = () => {
    ...
    <>
      ...
      >
        ...
        <div id="page-container">
          <div id="pf1" class="pf print:p-2 no-page-break pageA" data-page-no="1">
            <div className="px-10 py-2 text-[#344054] text-[15px] xl:text-[0.885vw]">
              <div className="text-center mb-[10px] xl:mb-[0.5vw]">
                ...
                <div className="text-[18px] xl:text-[0.938vw] font-normal mb-[10px] xl:mb-[0.8vw]">
                  (818) 241-3111
                </div>
              ...
              <div className="flex justify-between font-semibold border px-2 py-2 border-[#344054] print:mt-[0px]">
                <span>
              ...
              <div className="font-medium border px-4 py-1 print:py-[10px] border-[#344054]">
          ...
          <div id="pf2" class="pf  print:m-3 mt-0 no-page-break pageB" data-page-no="2">
            <div className="px-10 py-3 text-[#344054] text-[15px] xl:text-[0.885vw] print:m-2">
              ...
              <div className="mt-2 print:mt-[5px] print:pt-[5px]">
                <div className="grid grid-cols-2 lg:grid-cols-2 divide-x-2 divide-[#545454]">
                  ...
                  <div className="pl-0 mt-2 ">
                    ...
                    <div className="mt-10 mb-3 ml-5 print:mt-[5px]">
                      <div>
                        <b>
              ...
              <div className="sticky-page-number">
          ...
          <div id="pf3" class="pf print:p-2  no-page-break pageC" data-page-no="3">
            <div className="px-10 py-5 text-[#344054] text-[15px] xl:text-[0.885vw]">
              ...
              <div className="space-y-1">
                ...
                <div>
                  11. <b>FORCE MAJEURE CLAUSE.</b> The parties to the Contract shall be excused from performance thereunder during the time and to the extent that they are
                  prevented from obtaining, delivering, or performing by act of God, fire, strike, loss, or shortage of transportation facilities, lock-out commandeering of
                  materials, products, plants or facilities by the government when satisfactory evidence thereof is presented to the other party(ies), provided that it is satisfactorily
                  established that the non-performance is not due to the fault or neglect of the party not performing.
                </div>
                <div className="isMar2 sticky-page-number">
                  <div className="text-center">
                    <div>
                      <b>Page 3 of 8</b>
                    </div>
          ...
          <div id="pf3" class="pf print:p-2  no-page-break pageD" data-page-no="4">
            <div className="px-10 py-5 text-[#344054] text-[15px] xl:text-[0.885vw] mt-1">
              ...
              <div>
                13. <b>PAYMENT.</b> Unless otherwise specified, the Provider shall render invoices in triplicate for materials delivered or services performed under the
                Contract/Purchase Order. The District shall make payment for materials, supplies or other services furnished under this Contract as agreed within thirty (30)
                days after delivery to and approval by the authorized District representative of all invoices and other documentary evidence reasonably required by the District
                (which approval shall not be unreasonably withheld).
              </div>
              <div>
                14. <b>PERMITS AND LICENSES.</b> The Provider shall secure and maintain in force, at Provider's sole cost and expense, such licenses and permits as are required
                by law, in connection with the furnishing of services, materials, or supplies herein listed.
              </div>
          ...
          <div id="pf4" class="pf print:p-2  no-page-break pageE" data-page-no="5">
            <div className="px-10 py-2 text-[#344054] text-[15px] xl:text-[0.885vw] mt-2">
          ...
          <div id="pf4" class="pf print:p-2  no-page-break pageF" data-page-no="6">
            <div className="px-10 py-2 text-[#344054] text-[15px] xl:text-[0.885vw]">
              <div className="text-center mb-2">
                <div className="text-[24px] text-center xl:text-[1.250vw] font-semibold mt-1">
              ...
              <div className="text-center mb-7">
                <div className="text-[24px] xl:text-[1.250vw] font-semibold">Glendale Unified School District</div>
                <div className="text-[15px] xl:text-[0.781vw] font-semibold mb-2">Glendale, California</div>
                <div className="text-[24px] xl:text-[1.250vw] font-semibold mb-2">Personal Services Agreement</div>
              ...
              {/* <div className="mb-5">
                Are you a State Teachers Retirement System (STRS) retiree? 
                <br />
                <Checkbox inputId="cb1" onChange={e => setChecked(e.checked)} checked={checked} disabled></Checkbox>
              ...
              <div className="mb-5 print:mb-[10px]">
              ...
              {/* <div className="space-y-10">
                <div  style={{ width: "50%"}}>
                <div> <b className="text-[green] font-bold ml-2 w-[15.625vw]  print:w-[20.625vw]   border-b border-[#545454]">{props?.partyName && props?.partyName } </b></div>
                      <div style={{margin: "auto", width: "70%"}}>Approved By</div>
                </div>
          ...
          <div id="pf5" class="pf print:p-2  no-page-break pageG" data-page-no="7">
            <div className="px-10 py-5 text-[#344054] text-[16px] xl:text-[0.833vw]">
              ...
              <div className="sticky-page-number7">
                <div className="text-center mt-5">
                  <div>
                    <b>Page 7 of 8</b>
                  </div>
          ...
          {/* <div id="pf5" class="pf print:p-2  no-page-break pageH" data-page-no="8">
          
          </div> */}

          <div id="pf7" class="pf print:p-2  no-page-break pageI" data-page-no="9">
            <div className="px-10 py-5 text-[#344054] text-[16px] xl:text-[0.833vw]">
            ...
            <div className="sticky-page-number1">
