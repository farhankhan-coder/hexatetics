...
const PsaPdf3 = forwardRef((props, ref) => {
  const generatePDF = () => {
    ...
    <>
      ...
      >
        ...
        <div id="page-container">
          <div id="pf1" class="pf print:p-2 .no-print page-break page1" data-page-no="1" >
          ...
          <div id="pf2" class="pf  print:m-3 .no-print no-page-break page2" data-page-no="2">
          ...
          <div id="pf3" class="pf print:p-2 .no-print no-page-break page3" data-page-no="3">
            <div className="px-10 py-2 text-[#344054] text-[15px] xl:text-[0.885vw]">
              <div className="text-[24px] text-center xl:text-[1.250vw] font-semibold mb-1">
                GENERAL TERMS AND CONDITIONS
              </div>
              <div className="space-y-1">
                <div>
          ...
          <div id="pf3" class="pf print:p-2 .no-print no-page-break page4" data-page-no="4">
            <div className="px-10 py-1 text-[#344054] text-[15px] xl:text-[0.885vw] mt-1"> 
            <div>
          ...
          <div id="pf4" class="pf print:p-2 .no-print no-page-break page5" data-page-no="5">
            <div className="px-10 py-2 text-[#344054] text-[15px] xl:text-[0.885vw]">
            ...
            <div>
                ...
                //  border-[#344054] pb-2"
                 >
                  ...
                  26. <b>IF WORKING WITH STUDENTS.</b> Any Provider working with a student(s) must be supervised by a
          ...
          <div id="pf5" class="pf print:p-2 .no-print no-page-break page6" data-page-no="6">
            <div className="px-10 py-5 text-[#344054] text-[16px] xl:text-[0.833vw]">
              ...
              {/* <div className="mt-2">I HAVE READ THIS RELEASE.</div> */}
              {/* <div className="mt-2">
              ...
              {/* <b className="text-[green] font-bold ml-2 w-[15.625vw]  print:w-[20.625vw]   border-b border-[#545454]">
                    ...
                    <div> */}
              {/* <div style={{borderBottom: "1px solid", width: "70%",margin: "auto"}}>{props?.partyName && props?.partyName }</div> */}
              {/* <div> <b className="text-[green] font-bold ml-2 w-[15.625vw]  print:w-[20.625vw]   border-b border-[#545454]">{props?.partyName && props?.partyName } </b></div>
          ...
          <div id="pf5" class="pf print:p-2 .no-print no-page-break page7" data-page-no="7">
          ...
          <div id="pf7" class="pf print:p-2 .no-print no-page-break page8" data-page-no="8">
            <div className="px-10 py-5 text-[#344054] text-[16px] xl:text-[0.833vw]">
              ...
              <div style={{ position: "absolute", bottom: "30px", left: "50%", transform: "translateX(-50%)" }}>
                <div className="text-center mt-1 print:mt-[120px]">
                  <div>
                    <b>Page 8 of 8</b>
                  </div>
                </div>
