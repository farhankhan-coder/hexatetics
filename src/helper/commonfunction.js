...
//         myArray.push({ label: capitalizeFirst(key.toLowerCase()), value: key });
//     })
//     return myArray;
...
export { ConvertResponseForSelect, getResponseFromKeyCertifiedAdmin, GetValueFromArray, GetSingleValueFromResponse, ObjectLength, ObjectToArray, validateFileExtension, checkDuplicates, getResponseFromKey, ConvertResponseForSelectWithRefCode, ConvertResponseForSelectWithRefCodedropdown, ConvertResponseForEmployeeSelect, ConvertResponseOfNameCodeForSelect,ConvertResponseForEmployee,fetchGraphqlPaginatedRecords, ConvertResponseForSelectAbsenceCode };